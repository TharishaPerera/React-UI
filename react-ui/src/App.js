...
import SearchProductsBySupplierId from './components/pages/SearchProductsBySupplierId';
  ...
  return (
    ...
    <Router>
        ...
        <Routes>
            ...
            <Route path='/search-product-by-supplier-id' element={<SearchProductsBySupplierId />} />
