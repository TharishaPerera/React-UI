            ...
            <div classNameName="row mt-3">
                <div className="row g-3">
                    <form className="col-md-4 mt-5">
                        <label for="supplierName" className="form-label" >Enter Supplier Name:</label>
                        <input type="text" className="form-control" id="supplierName" value={supplierName} onChange={(e) => setSupplierName(e.target.value)} />
...
export default SearchSupplierByName